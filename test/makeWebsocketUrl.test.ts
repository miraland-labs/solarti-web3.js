...
const TEST_CASES = [
  // Non-https => `ws`
  ['http://api.devnet-mln.miraland.top/', 'ws://api.devnet-mln.miraland.top/'],
  ['gopher://gopher.example.com/', 'ws://gopher.example.com/'],
  ['http://localhost/', 'ws://localhost/'],
  // `https` => `wss`
  ['https://api.devnet-mln.miraland.top/', 'wss://api.devnet-mln.miraland.top/'],
  // IPv4 address
  ...
  ['https://api.devnet-mln.miraland.top:80/', 'wss://api.devnet-mln.miraland.top:81/'],
